...
<body>
    @if(! Route::is('login'))
        <header class="header">
            ...
            <nav class="nav">
                <a href="{{ route('login') }}"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="25px" viewBox="0 0 24 24" width="25px" fill="#000000"><g><path d="M0,0h24v24H0V0z" fill="none"/></g><g><g><polygon points="5,5 12,5 12,3 3,3 3,21 12,21 12,19 5,19"/><polygon points="21,12 17,8 17,11 9,11 9,13 17,13 17,16"/></g></g></svg></a>
            </nav>
        </header>
    @endif
    @yield('main')
